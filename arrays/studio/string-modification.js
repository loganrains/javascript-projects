...
console.log(`Our original institution of ${str} is now ${strNew}!`);
...
if (Number(info) >= 0 && Number(info) <= 10) {
    ...
    console.log(`You have chosen ${info}, which is a value larger than the length of the word, so we chose 3 letters instead.`);
    strBack =  str.slice(3);
    strNew = strBack + strFront;
    console.log(strNew);
}